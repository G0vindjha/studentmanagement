...
<div class="col-10 mb-3">
  ...
  <div class="col-12 mt-3 d-flex justify-content-end pe-5">
    <a name="back" id="back" class="btn btn-primary me-5" href="/admin/employeeList.php" role="button">BACK</a>
  </div>
      ...
      <div class="row justify-content-center align-items-center g-2">
        ...
        <div class="col">
          ...
          <select class="form-select" id="state" name="state" required>
            ...
            // );
            $conn2 = new Conn();
            $result3 = $conn2->select('state', "*", null, null, "country_Id = $data");
        ...
        <div class="col">
          ...
          $data = $updateResult['state'];
            ...
            // );
            $conn1 = new Conn();
            $result2 = $conn1->select('city', "*", null, null, "state_Id = $data", $data);
