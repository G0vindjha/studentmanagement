...
class Conn
{
    ...
    {
        $this->conn = mysqli_connect("localhost","root","","EmployeeModule");
        $this->conn = mysqli_connect($hostName, $userName, $password, "EmployeeModule") or die("Connection Faield!!!");
        // Check connection
        // if (mysqli_connect_errno()) {
        //   echo "Failed to connect to MySQL: " . mysqli_connect_error();
        //   exit();
        // }
        echo '<br>Govind<br>File: '. __FILE__.'<br>Line: '.__LINE__.'<br><pre>';print_r($this->conn);echo '</pre>'; die();
