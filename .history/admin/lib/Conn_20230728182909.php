...
class Conn
{
    ...
    {
        $this->conn = mysqli_connect('database', 'root', 'deep70', "EmployeeModule") or die("Connection Faield!!!");

        // try {
            
        //         $this->conn = new PDO("mysql:host=database;dbname=EmployeeModule", 'root', 'deep70');
    ...
    public function select($table, $fields = "*", $join = "", $joinParam = '', $where = "", $whereParam = '', $groupbyFieldName = "", $orderFieldName = "", $order = "", $limit = "")
    {
        ...
        $row = mysqli_query($this->conn, $sql) or die("Query Faild!!");
        echo '<br>Govind<br>File: '. __FILE__.'<br>Line: '.__LINE__.'<br><pre>';print_r($rows);echo '</pre>'; die();
        ...
        //     }
        // }
        // echo '<br>Govind<br>File: '. __FILE__.'<br>Line: '.__LINE__.'<br><pre>';print_r($sql);echo '</pre>'; die();
