...
<div class=" col-11">
 ...
 <div class="col-12 d-flex justify-content-center">
  <img src="/studentmanagement/admin/assets/img/softwareUse.png" class="img-fluid rounded-top" alt="">
 </div>
 <!-- Employee of the month  -->
  <div class="container">
    <div class="col-12 mt-3 mb-1">
      
      <h5 class="text-uppercase display-5 text-center"><img src="/studentmanagement/admin/assets/img/badge.png" alt="..." width='50px'>Employee Of The Month<img src="../admin/assets/img/badge.png" alt="..." width='50px'></h5>
    </div>
        ...
        <section class="mx-auto my-5" style="max-width: 23rem;">
          ...
          <div class="card testimonial-card mt-2 mb-3">
            ...
            <div class="avatar mx-auto white">
              <img src="/studentmanagement/admin/assets/img/avatarimg.png" class="rounded-circle img-fluid" alt="woman avatar">
            </div>
      ...
      <div class="col">
        <section class="mx-auto my-5" style="max-width: 23rem;">
          ...
          <div class="card testimonial-card mt-2 mb-3">
            <div class="card-up aqua-gradient"></div>
            <div class="avatar mx-auto white">
              <img src="/studentmanagement/admin/assets/img/pngwing.com (8).png" class="rounded-circle img-fluid" alt="woman avatar">
            </div>
            <div class="card-body text-center">
      ...
      <div class="col">
        <section class="mx-auto my-5" style="max-width: 23rem;">
          ...
          <div class="card testimonial-card mt-2 mb-3">
            <div class="card-up aqua-gradient"></div>
            <div class="avatar mx-auto white">
              <img src="/studentmanagement/admin/assets/img/pngwinggirl.com .png" class="rounded-circle img-fluid" alt="woman avatar">
            </div>
            <div class="card-body text-center">
...
<script src="/studentmanagement/admin/assets/js/script.js"></script>
<?php
echo $script;
